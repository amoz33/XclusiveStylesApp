                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Edit Dress Category</h6>
                                </div>
                                <div class="card-body">
                                	<?php
						               $formArray = array('class'=>'', 'id'=>'', 'role'=>'form', 'method'=>'post');
						               echo form_open('Category/edit_dress_category', $formArray) ;?>
						                ...
						                <div class="form-row justify-content-md-center">
                                            ...
                                            <div class="form-group col-md-5">
                                                <h6>Category Name</h6>
                                                <input class="form-control" type="text" name="dress_category" value="<?php echo $result['category_name'];?>" required />
                                            </div>
                                        ...
                                        <hr>
                                            <div class="form-group col-md-5">
                                              ...
                                              <?php echo  anchor('Category/dress_category','Cancel',array('class'=>'btn btn-danger text-white'));?>
                                            </div>
						                </div>
